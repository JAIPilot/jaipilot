...
3. Run configured JaCoCo, PIT, ArchUnit, OpenRewrite, or static-analysis tasks when they apply.
   ...
   materially help, follow the `jaipilot-clean-java` tool procedure. For a justified bounded
   migration, invoke `jaipilot-openrewrite`. Obtain approval before adding either tool.
